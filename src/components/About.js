        ...
        <div className='aboutmeWrapper'>
          <section className='aboutmeSection'>
            ...
            <div className="aboutProfilePicWrapper">
              <img className="aboutProfilePic" src={process.env.PUBLIC_URL + "/images/purty.jpeg"} />
            </div>
            ...
            <p className='aboutme'>
              ...
              My experience at Apple allowed me to work and improve as a team player. I worked closely with designers on new map features which included planning out workflows on the delivery of the features to maximize discoverability,
              interface behaviors, and how information is being navigated and displayed. I built analytics dashboards with <strong>PostgreSQL, ArcGIS, and QGIS</strong> to report on
